...
/**
 * This is the item provider adapter for a {@link sirius_new.Milestone} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MilestoneItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Milestone_name_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Milestone_name_feature",
								"_UI_Milestone_type"),
						Sirius_newPackage.Literals.MILESTONE__NAME, true, false, false,
	...
	protected void addDescriptionPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Milestone_description_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Milestone_description_feature",
								"_UI_Milestone_type"),
						Sirius_newPackage.Literals.MILESTONE__DESCRIPTION, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addCompletionDatePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Milestone_completionDate_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Milestone_completionDate_feature",
								"_UI_Milestone_type"),
						Sirius_newPackage.Literals.MILESTONE__COMPLETION_DATE, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
