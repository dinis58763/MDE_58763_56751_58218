 ...
 * </p>
 * <ul>
 *   <li>{@link sirius_new.impl.DegreeImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DegreeImpl extends MinimalEObjectImpl.Container implements Degree {
	...
	protected EClass eStaticClass() {
		return Sirius_newPackage.Literals.DEGREE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Sirius_newPackage.DEGREE__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case Sirius_newPackage.DEGREE__NAME:
			return getName();
		}
